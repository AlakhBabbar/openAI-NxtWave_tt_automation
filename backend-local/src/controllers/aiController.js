...
class AIController {
  ...
  async chat(req, res) {
    try {
      ...
      const response = await openaiService.chat(history, message);
  ...
  async analyzeTimetable(req, res) {
    try {
      ...
      const analysis = await openaiService.analyzeTimetable(timetableData, analysisType);
  ...
  async healthCheck(req, res) {
    try {
      ...
      const testResponse = await openaiService.generateText('Hello, respond with "AI service is working"');
